  ...
  return (
    <Box
      sx={{
        display: showLG,
        flexGrow: "auto",
        bgcolor: theme.palette.mode === "light" ? "beige" : "#1e1e1e",
        pl: 2,
      }}
      component="section"
    >
      ...
      <AvatarGroup sx={{ justifyContent: "center", my: 2 }} total={24}>
        <Avatar
          ...
          alt="Travis Howard"
          src="https://i.pinimg.com/236x/21/86/9b/21869b9a7c2bd944619f898e107f2c2d.jpg"
        />

        <Avatar
          sx={{ width: 49, height: 45 }}
          alt="Remy Sharp"
          src="https://i.pinimg.com/236x/ce/72/c6/ce72c6a5112e4c98fbd9ed1f0f8edc62.jpg"
        />

        <Avatar
          sx={{ width: 49, height: 45 }}
          alt="Agnes Walker"
          src="https://i.pinimg.com/236x/ef/84/3c/ef843c511f1e459cf956566080a6e4bc.jpg"
        />
        <Avatar
          sx={{ width: 49, height: 45 }}
          alt="Trevor Henderson"
          src="https://i.pinimg.com/236x/18/d5/66/18d566e8f6f8a414ab2fc2d6d9ce8060.jpg"
        />
      </AvatarGroup>
